...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OWHS" Or strTab = "OITM" Or strTab = "INV1" Or strTab = "OWTR" Or strTab = "OUSR" Or strTab = "OITW" Or strTab = "RDR1" Or strTab = "OINV" Or strTab = "INV1" Or strTab = "OWOR") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            'User Defined Field
            addField("INV1", "Z_MItemType", "Item Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "M,A", "Main,Add-on", "M")
            AddFields("INV1", "Z_MRelateItem", "Related Main Item", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            '---- User Defined Object
            CreateUDO()
